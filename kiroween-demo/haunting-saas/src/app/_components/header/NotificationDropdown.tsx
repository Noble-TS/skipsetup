          ...
          <li>
            ...
            >
              <span className="relative z-1 block h-10 w-full max-w-10 rounded-full">
                ...
                />
                <span className="absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-emerald-500 dark:border-gray-900"></span>
              </span>
            ...
            >
              <span className="relative z-1 block h-10 w-full max-w-10 rounded-full">
                <Image
                  ...
                  className="w-full overflow-hidden rounded-full"
                />
                <span className="absolute right-0 bottom-0 z-10 h-2.5 w-full max-w-2.5 rounded-full border-[1.5px] border-white bg-red-500 dark:border-gray-900"></span>
              </span>
